...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x0epayment_events\x18\t \x03(\v2\x1d.lift.payment.v1.PaymentEventR\rpaymentEvents\x124\n" +
	...
	"\apayment\x18\x01 \x01(\v2\x18.lift.payment.v1.PaymentR\apayment\"\x98\x01\n" +
	"\x1bRidePaymentAuthorizeRequest\x12,\n" +
	"\x12service_request_id\x18\x01 \x01(\tR\x10serviceRequestId\x123\n" +
	"\x16user_payment_method_id\x18\x02 \x01(\tR\x13userPaymentMethodId\x12\x16\n" +
	"\x06amount\x18\x03 \x01(\x01R\x06amount\"R\n" +
	"\x1cRidePaymentAuthorizeResponse\x122\n" +
	"\apayment\x18\x01 \x01(\v2\x18.lift.payment.v1.PaymentR\apayment\"a\n" +
	"\x19RidePaymentCaptureRequest\x12,\n" +
	...
	"\x12service_request_id\x18\x01 \x01(\tR\x10serviceRequestId\"\xcf\x02\n" +
	"\x19RidePaymentStatusResponse\x12,\n" +
	"\x12service_request_id\x18\x01 \x01(\tR\x10serviceRequestId\x12%\n" +
	"\x0epayment_status\x18\x02 \x01(\tR\rpaymentStatus\x12!\n" +
	"\fpayment_type\x18\x03 \x01(\tR\vpaymentType\x12+\n" +
	"\x11authorized_amount\x18\x04 \x01(\x01R\x10authorizedAmount\x12'\n" +
	"\x0fcaptured_amount\x18\x05 \x01(\x01R\x0ecapturedAmount\x124\n" +
	"\x16gateway_transaction_id\x18\x06 \x01(\tR\x14gatewayTransactionId\x12.\n" +
	"\x13user_payment_method\x18\a \x01(\tR\x11userPaymentMethod\"H\n" +
	...
	"\x11GetServiceRequest\x12).lift.payment.v1.GetServiceRequestRequest\x1a*.lift.payment.v1.GetServiceRequestResponse\x12s\n" +
	"\x14RidePaymentAuthorize\x12,.lift.payment.v1.RidePaymentAuthorizeRequest\x1a-.lift.payment.v1.RidePaymentAuthorizeResponse\x12m\n" +
	"\x12RidePaymentCapture\x12*.lift.payment.v1.RidePaymentCaptureRequest\x1a+.lift.payment.v1.RidePaymentCaptureResponse\x12m\n" +
	"\x12RidePaymentReverse\x12*.lift.payment.v1.RidePaymentReverseRequest\x1a+.lift.payment.v1.RidePaymentReverseResponse\x12j\n" +
	"\x11RidePaymentStatus\x12).lift.payment.v1.RidePaymentStatusRequest\x1a*.lift.payment.v1.RidePaymentStatusResponse2o\n" +
