...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\tpromocode\x18\x01 \x01(\v2\x1a.lift.payment.v1.PromoCodeR\tpromocode2\xc7\n" +
	"\n" +
	...
	"\x1dAddPromoCodeUserPaymentMethod\x125.lift.payment.v1.AddPromoCodeUserPaymentMethodRequest\x1a6.lift.payment.v1.AddPromoCodeUserPaymentMethodResponse\x12\x9d\x01\n" +
...
var file_payment_v1_payment_proto_goTypes = []any{
	...
	(*EnsureDefaultCashUserPaymentMethodRequest)(nil),  // 19: lift.payment.v1.EnsureDefaultCashUserPaymentMethodRequest
	(*EnsureDefaultCashUserPaymentMethodResponse)(nil), // 20: lift.payment.v1.EnsureDefaultCashUserPaymentMethodResponse
	(*Payment)(nil),                      // 21: lift.payment.v1.Payment
	(*PaymentEvent)(nil),                 // 22: lift.payment.v1.PaymentEvent
	(*ListPaymentsByMethodRequest)(nil),  // 23: lift.payment.v1.ListPaymentsByMethodRequest
	(*ListPaymentsByMethodResponse)(nil), // 24: lift.payment.v1.ListPaymentsByMethodResponse
	(*InsertPaymentRequest)(nil),         // 25: lift.payment.v1.InsertPaymentRequest
	(*InsertPaymentResponse)(nil),        // 26: lift.payment.v1.InsertPaymentResponse
	(*GetServiceRequestRequest)(nil),     // 27: lift.payment.v1.GetServiceRequestRequest
	(*ServiceRequest)(nil),               // 28: lift.payment.v1.ServiceRequest
	(*GetServiceRequestResponse)(nil),    // 29: lift.payment.v1.GetServiceRequestResponse
	(*PromoCode)(nil),                    // 30: lift.payment.v1.PromoCode
	(*GetPromoCodeRequest)(nil),          // 31: lift.payment.v1.GetPromoCodeRequest
	(*GetPromoCodeResponse)(nil),         // 32: lift.payment.v1.GetPromoCodeResponse
	(*timestamppb.Timestamp)(nil),        // 33: google.protobuf.Timestamp
	(*structpb.Struct)(nil),              // 34: google.protobuf.Struct
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	33, // 0: lift.payment.v1.UserPaymentMethod.created_time:type_name -> google.protobuf.Timestamp
	33, // 1: lift.payment.v1.UserPaymentMethod.updated_time:type_name -> google.protobuf.Timestamp
	34, // 2: lift.payment.v1.UserPaymentMethod.extended_parameters:type_name -> google.protobuf.Struct
	...
	0,  // 11: lift.payment.v1.EnsureDefaultCashUserPaymentMethodResponse.method:type_name -> lift.payment.v1.UserPaymentMethod
	33, // 12: lift.payment.v1.Payment.created_time:type_name -> google.protobuf.Timestamp
	33, // 13: lift.payment.v1.Payment.updated_time:type_name -> google.protobuf.Timestamp
	22, // 14: lift.payment.v1.Payment.payment_events:type_name -> lift.payment.v1.PaymentEvent
	33, // 15: lift.payment.v1.PaymentEvent.created_time:type_name -> google.protobuf.Timestamp
	33, // 16: lift.payment.v1.PaymentEvent.updated_time:type_name -> google.protobuf.Timestamp
	33, // 17: lift.payment.v1.ListPaymentsByMethodRequest.start_time:type_name -> google.protobuf.Timestamp
	33, // 18: lift.payment.v1.ListPaymentsByMethodRequest.end_time:type_name -> google.protobuf.Timestamp
	21, // 19: lift.payment.v1.ListPaymentsByMethodResponse.payments:type_name -> lift.payment.v1.Payment
	22, // 20: lift.payment.v1.InsertPaymentRequest.payment_events:type_name -> lift.payment.v1.PaymentEvent
	21, // 21: lift.payment.v1.InsertPaymentResponse.payment:type_name -> lift.payment.v1.Payment
	28, // 22: lift.payment.v1.GetServiceRequestResponse.request:type_name -> lift.payment.v1.ServiceRequest
	33, // 23: lift.payment.v1.PromoCode.start_time:type_name -> google.protobuf.Timestamp
	33, // 24: lift.payment.v1.PromoCode.end_time:type_name -> google.protobuf.Timestamp
	30, // 25: lift.payment.v1.GetPromoCodeResponse.promocode:type_name -> lift.payment.v1.PromoCode
	1,  // 26: lift.payment.v1.PaymentMethodService.ListUserPaymentMethods:input_type -> lift.payment.v1.ListUserPaymentMethodsRequest
	3,  // 27: lift.payment.v1.PaymentMethodService.GetPaymentMethod:input_type -> lift.payment.v1.GetPaymentMethodRequest
	5,  // 28: lift.payment.v1.PaymentMethodService.GetCorporatePaymentMethod:input_type -> lift.payment.v1.GetCorporatePaymentMethodRequest
	7,  // 29: lift.payment.v1.PaymentMethodService.ListCorporatePaymentMethods:input_type -> lift.payment.v1.ListCorporatePaymentMethodsRequest
	9,  // 30: lift.payment.v1.PaymentMethodService.UpdatePaymentMethodStatus:input_type -> lift.payment.v1.UpdatePaymentMethodStatusRequest
	11, // 31: lift.payment.v1.PaymentMethodService.UpdateUserPaymentMethod:input_type -> lift.payment.v1.UpdateUserPaymentMethodRequest
	13, // 32: lift.payment.v1.PaymentMethodService.SetDefaultUserPaymentMethod:input_type -> lift.payment.v1.SetDefaultUserPaymentMethodRequest
	15, // 33: lift.payment.v1.PaymentMethodService.DeleteUserPaymentMethod:input_type -> lift.payment.v1.DeleteUserPaymentMethodRequest
	17, // 34: lift.payment.v1.PaymentMethodService.AddPromoCodeUserPaymentMethod:input_type -> lift.payment.v1.AddPromoCodeUserPaymentMethodRequest
	19, // 35: lift.payment.v1.PaymentMethodService.EnsureDefaultCashUserPaymentMethod:input_type -> lift.payment.v1.EnsureDefaultCashUserPaymentMethodRequest
	25, // 36: lift.payment.v1.PaymentService.InsertPayment:input_type -> lift.payment.v1.InsertPaymentRequest
	23, // 37: lift.payment.v1.PaymentService.ListPaymentsByMethod:input_type -> lift.payment.v1.ListPaymentsByMethodRequest
	27, // 38: lift.payment.v1.PaymentService.GetServiceRequest:input_type -> lift.payment.v1.GetServiceRequestRequest
	31, // 39: lift.payment.v1.PromoCodeService.GetPromoCode:input_type -> lift.payment.v1.GetPromoCodeRequest
	2,  // 40: lift.payment.v1.PaymentMethodService.ListUserPaymentMethods:output_type -> lift.payment.v1.ListUserPaymentMethodsResponse
	4,  // 41: lift.payment.v1.PaymentMethodService.GetPaymentMethod:output_type -> lift.payment.v1.GetPaymentMethodResponse
	6,  // 42: lift.payment.v1.PaymentMethodService.GetCorporatePaymentMethod:output_type -> lift.payment.v1.GetCorporatePaymentMethodResponse
	8,  // 43: lift.payment.v1.PaymentMethodService.ListCorporatePaymentMethods:output_type -> lift.payment.v1.ListCorporatePaymentMethodsResponse
	10, // 44: lift.payment.v1.PaymentMethodService.UpdatePaymentMethodStatus:output_type -> lift.payment.v1.UpdatePaymentMethodStatusResponse
	12, // 45: lift.payment.v1.PaymentMethodService.UpdateUserPaymentMethod:output_type -> lift.payment.v1.UpdateUserPaymentMethodResponse
	14, // 46: lift.payment.v1.PaymentMethodService.SetDefaultUserPaymentMethod:output_type -> lift.payment.v1.SetDefaultUserPaymentMethodResponse
	16, // 47: lift.payment.v1.PaymentMethodService.DeleteUserPaymentMethod:output_type -> lift.payment.v1.DeleteUserPaymentMethodResponse
	18, // 48: lift.payment.v1.PaymentMethodService.AddPromoCodeUserPaymentMethod:output_type -> lift.payment.v1.AddPromoCodeUserPaymentMethodResponse
	20, // 49: lift.payment.v1.PaymentMethodService.EnsureDefaultCashUserPaymentMethod:output_type -> lift.payment.v1.EnsureDefaultCashUserPaymentMethodResponse
	26, // 50: lift.payment.v1.PaymentService.InsertPayment:output_type -> lift.payment.v1.InsertPaymentResponse
	24, // 51: lift.payment.v1.PaymentService.ListPaymentsByMethod:output_type -> lift.payment.v1.ListPaymentsByMethodResponse
	29, // 52: lift.payment.v1.PaymentService.GetServiceRequest:output_type -> lift.payment.v1.GetServiceRequestResponse
	32, // 53: lift.payment.v1.PromoCodeService.GetPromoCode:output_type -> lift.payment.v1.GetPromoCodeResponse
