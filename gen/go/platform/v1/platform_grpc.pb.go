...
func (UnimplementedEmailGatewayConfigServiceServer) GetEmailGatewayConfig(context.Context, *GetEmailGatewayConfigRequest) (*GetEmailGatewayConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEmailGatewayConfig not implemented")
}
...
func RegisterEmailGatewayConfigServiceServer(s grpc.ServiceRegistrar, srv EmailGatewayConfigServiceServer) {
	// If the following call panics, it indicates UnimplementedEmailGatewayConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// OtpConfigServiceClient is the client API for OtpConfigService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type OtpConfigServiceClient interface {
	GetOtpSettings(ctx context.Context, in *GetOtpSettingsRequest, opts ...grpc.CallOption) (*GetOtpSettingsResponse, error)
}

type otpConfigServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewOtpConfigServiceClient(cc grpc.ClientConnInterface) OtpConfigServiceClient {
	return &otpConfigServiceClient{cc}
}

func (c *otpConfigServiceClient) GetOtpSettings(ctx context.Context, in *GetOtpSettingsRequest, opts ...grpc.CallOption) (*GetOtpSettingsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOtpSettingsResponse)
	err := c.cc.Invoke(ctx, OtpConfigService_GetOtpSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// OtpConfigServiceServer is the server API for OtpConfigService service.
// All implementations must embed UnimplementedOtpConfigServiceServer
// for forward compatibility.
type OtpConfigServiceServer interface {
	GetOtpSettings(context.Context, *GetOtpSettingsRequest) (*GetOtpSettingsResponse, error)
	mustEmbedUnimplementedOtpConfigServiceServer()
}

// UnimplementedOtpConfigServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedOtpConfigServiceServer struct{}

func (UnimplementedOtpConfigServiceServer) GetOtpSettings(context.Context, *GetOtpSettingsRequest) (*GetOtpSettingsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOtpSettings not implemented")
}
func (UnimplementedOtpConfigServiceServer) mustEmbedUnimplementedOtpConfigServiceServer() {}
func (UnimplementedOtpConfigServiceServer) testEmbeddedByValue()                          {}

// UnsafeOtpConfigServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to OtpConfigServiceServer will
// result in compilation errors.
type UnsafeOtpConfigServiceServer interface {
	mustEmbedUnimplementedOtpConfigServiceServer()
}

func RegisterOtpConfigServiceServer(s grpc.ServiceRegistrar, srv OtpConfigServiceServer) {
	// If the following call panics, it indicates UnimplementedOtpConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&OtpConfigService_ServiceDesc, srv)
}

func _OtpConfigService_GetOtpSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOtpSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OtpConfigServiceServer).GetOtpSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OtpConfigService_GetOtpSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OtpConfigServiceServer).GetOtpSettings(ctx, req.(*GetOtpSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// OtpConfigService_ServiceDesc is the grpc.ServiceDesc for OtpConfigService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var OtpConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lift.platform.v1.OtpConfigService",
	HandlerType: (*OtpConfigServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetOtpSettings",
			Handler:    _OtpConfigService_GetOtpSettings_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "platform/v1/platform.proto",
...
const (
	SecurityConfigService_GetSecurityConfig_FullMethodName = "/lift.platform.v1.SecurityConfigService/GetSecurityConfig"
)

// SecurityConfigServiceClient is the client API for SecurityConfigService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type SecurityConfigServiceClient interface {
	GetSecurityConfig(ctx context.Context, in *GetSecurityConfigRequest, opts ...grpc.CallOption) (*SecurityConfigResponse, error)
}

type securityConfigServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewSecurityConfigServiceClient(cc grpc.ClientConnInterface) SecurityConfigServiceClient {
	return &securityConfigServiceClient{cc}
}

func (c *securityConfigServiceClient) GetSecurityConfig(ctx context.Context, in *GetSecurityConfigRequest, opts ...grpc.CallOption) (*SecurityConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SecurityConfigResponse)
	err := c.cc.Invoke(ctx, SecurityConfigService_GetSecurityConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// SecurityConfigServiceServer is the server API for SecurityConfigService service.
// All implementations must embed UnimplementedSecurityConfigServiceServer
// for forward compatibility.
type SecurityConfigServiceServer interface {
	GetSecurityConfig(context.Context, *GetSecurityConfigRequest) (*SecurityConfigResponse, error)
	mustEmbedUnimplementedSecurityConfigServiceServer()
}

// UnimplementedSecurityConfigServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedSecurityConfigServiceServer struct{}

func (UnimplementedSecurityConfigServiceServer) GetSecurityConfig(context.Context, *GetSecurityConfigRequest) (*SecurityConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSecurityConfig not implemented")
}
func (UnimplementedSecurityConfigServiceServer) mustEmbedUnimplementedSecurityConfigServiceServer() {}
func (UnimplementedSecurityConfigServiceServer) testEmbeddedByValue()                               {}

// UnsafeSecurityConfigServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to SecurityConfigServiceServer will
// result in compilation errors.
type UnsafeSecurityConfigServiceServer interface {
	mustEmbedUnimplementedSecurityConfigServiceServer()
}

func RegisterSecurityConfigServiceServer(s grpc.ServiceRegistrar, srv SecurityConfigServiceServer) {
	// If the following call panics, it indicates UnimplementedSecurityConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&SecurityConfigService_ServiceDesc, srv)
}

func _SecurityConfigService_GetSecurityConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSecurityConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecurityConfigServiceServer).GetSecurityConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecurityConfigService_GetSecurityConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecurityConfigServiceServer).GetSecurityConfig(ctx, req.(*GetSecurityConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// SecurityConfigService_ServiceDesc is the grpc.ServiceDesc for SecurityConfigService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var SecurityConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lift.platform.v1.SecurityConfigService",
	HandlerType: (*SecurityConfigServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSecurityConfig",
			Handler:    _SecurityConfigService_GetSecurityConfig_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "platform/v1/platform.proto",
