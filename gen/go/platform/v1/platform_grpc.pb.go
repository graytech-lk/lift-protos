...
func (UnimplementedCustomerAppConfigServiceServer) GetCustomerAppConfigByCategory(context.Context, *GetCustomerAppConfigByCategoryRequest) (*GetCustomerAppConfigByCategoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCustomerAppConfigByCategory not implemented")
}
...
func RegisterCustomerAppConfigServiceServer(s grpc.ServiceRegistrar, srv CustomerAppConfigServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomerAppConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedVehicleTypeServiceServer) SetVehicleTypeStatus(context.Context, *SetVehicleTypeStatusRequest) (*SetVehicleTypeStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetVehicleTypeStatus not implemented")
}
...
func RegisterVehicleTypeServiceServer(s grpc.ServiceRegistrar, srv VehicleTypeServiceServer) {
	// If the following call pancis, it indicates UnimplementedVehicleTypeServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedSmsGatewayConfigServiceServer) GetSmsGatewayConfig(context.Context, *GetSmsGatewayConfigRequest) (*GetSmsGatewayConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSmsGatewayConfig not implemented")
}
...
func RegisterSmsGatewayConfigServiceServer(s grpc.ServiceRegistrar, srv SmsGatewayConfigServiceServer) {
	// If the following call pancis, it indicates UnimplementedSmsGatewayConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedOtpConfigServiceServer) GetOtpSettings(context.Context, *GetOtpSettingsRequest) (*GetOtpSettingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOtpSettings not implemented")
}
...
func RegisterOtpConfigServiceServer(s grpc.ServiceRegistrar, srv OtpConfigServiceServer) {
	// If the following call pancis, it indicates UnimplementedOtpConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterSecurityConfigServiceServer(s grpc.ServiceRegistrar, srv SecurityConfigServiceServer) {
	// If the following call pancis, it indicates UnimplementedSecurityConfigServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
