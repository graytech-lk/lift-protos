...
const file_notification_v1_notification_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x11\n" +
	"\x0fSendSmsResponse\"\xb9\x02\n" +
	"\x14SendTestEmailRequest\x12\x1c\n" +
	"\trecipient\x18\x01 \x01(\tR\trecipient\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x03 \x01(\tR\x04port\x12\x1e\n" +
	"\n" +
	"encryption\x18\x04 \x01(\tR\n" +
	"encryption\x12#\n" +
	"\rauth_required\x18\x05 \x01(\bR\fauthRequired\x12#\n" +
	"\rsmtp_username\x18\x06 \x01(\tR\fsmtpUsername\x12\x1a\n" +
	"\bpassword\x18\a \x01(\tR\bpassword\x12\x1d\n" +
	"\n" +
	"from_email\x18\b \x01(\tR\tfromEmail\x12\x1b\n" +
	"\tfrom_name\x18\t \x01(\tR\bfromName\x12\x19\n" +
	"\breply_to\x18\n" +
	" \x01(\tR\areplyTo\"A\n" +
	"\x15SendTestEmailResponse\x12\x12\n" +
	"\x04sent\x18\x01 \x01(\bR\x04sent\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error2\xaf\x02\n" +
	...
	"\aSendSms\x12$.lift.notification.v1.SendSmsRequest\x1a%.lift.notification.v1.SendSmsResponse\x12h\n" +
	"\rSendTestEmail\x12*.lift.notification.v1.SendTestEmailRequest\x1a+.lift.notification.v1.SendTestEmailResponseBJZHgithub.com/graytech-lk/lift-protos/gen/go/notification/v1;notificationv1b\x06proto3"
